...
<div id="page">
<div id="block2">
<h1 align="center"><b>LIST OF VOLUNTEER</b></h1>
...
$select_q="select * from volunteerlist";
...
<td><?php echo $r['enroll']; ?></td>
<td><?php echo $r['course']; ?></td>
<td><?php echo $r['eventassign']; ?></td>
<td> <a href="editvolunteer.php?id=<?php echo $r['id']; ?>"> Edit </td> <td><a href="deletevolunteer.php?id=<?php echo $r['id']; ?>" > Delete</a></td>
    </tr>
<?php } ?>
